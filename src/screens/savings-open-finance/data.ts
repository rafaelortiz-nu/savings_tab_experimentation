...
export const savingsOpenFinanceData = {
  title: "Savings",
  ...
  totalBalance: "$9,502.30",
  yieldStart: 25.0,
  yieldTarget: 31.18,
  balanceTrend: "+ $31.18 in yield today",
  ...
  otherBanksTitle: "Other Banks",
  otherBankLabel: "Savings on Caixa",
  otherBankAmount: "$5,902.00",
  otherBankMainIcon: "pig" as const,
  otherBankBadgeIcon: "logoCaixa" as const,
